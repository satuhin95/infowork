...
if (!isset($_SESSION['admin_name']) || !$_SESSION['admin_name']) {
  ...
  $query1 = "SELECT * FROM adminInfo WHERE admin_name = '$adminName'";
  $stmt1 = $db->prepare($query1);
  $stmt1->execute();
  $adminInfoRes = $stmt1->fetch(PDO::FETCH_ASSOC);


  $query = "SELECT * FROM campaignInfo inner join userInfo on campaignInfo.user_id = userInfo.user_id";
  ...
  foreach ($results as $row) {
    ...
    $b = <<<STR
      ...
      <td class=" d-xl-table-cell">{$row["user_name"]}</td>
          ...
          <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
              ...
              <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                ...
                <span class="text-dark"><?php echo $adminName; ?></span>
              </a>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-auto">
                            <div class="stat text-primary ib-color-6">
                ...
                <table class="table table-striped table-hover my-0 campaignTable_full">
                  <thead>
                    <tr>
                      ...
                      <th class=" d-xl-table-cell">TrueView</th>
