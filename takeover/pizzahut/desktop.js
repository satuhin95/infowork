...
<!-- overlay image css -->
<style>
.istation__wrapper *{margin:0;padding:0;box-sizing:border-box; }#istation_image_overlay_section{position:relative;;overflow:hidden;top:0;left:0;}.istation__wrapper #leftImage{top:0;left:0;width:50% !important;height:100% !important;object-fit:fill;position:absolute;margin:initial;}.istation__wrapper #rightImage{right:0;top:0;width:50.2% !important;height:100% !important;object-fit:fill;position:absolute;margin:initial;left:initial;}.istation__wrapper #textImage{top:50%;left:78%;width:140px !important;animation-delay:1s;animation-duration:2s;height:auto; margin:0;}
   #textImage2{top:55%;left:55%;width:140px !important;animation-delay:1s;animation-duration:2s;height:auto; margin:0;}
 .istation__wrapper .istation_overlay_img{bottom:0;left:0;width:100%;animation-duration:2s;height: auto;top:initial;right:initial}.absolute{position:absolute}.hidden{display:none}.animate__animated{animation-duration:1s;animation-fill-mode:both}.animate__fadeInLeft{animation-name:fadeInLeft}@keyframes fadeInLeft{0%{opacity:0;transform:translate3d(-100%,0,0)}to{opacity:1;transform:translateZ(0)}}.animate__fadeInRight{animation-name:fadeInRight}@keyframes fadeInRight{0%{opacity:0;transform:translate3d(100%,0,0)}to{opacity:1;transform:translateZ(0)}}.animate__zoomIn{animation-name:zoomIn}@keyframes zoomIn{0%{opacity:0;transform:scale3d(.3,.3,.3)}50%{opacity:1}}@keyframes zoomOut{0%{opacity:1}50%{opacity:0;transform:scale3d(.3,.3,.3)}to{opacity:0}}.animate__zoomOut{animation-name:zoomOut}@keyframes fadeOutLeft{0%{opacity:1}to{opacity:0;transform:translate3d(-100%,0,0)}}.animate__fadeOutLeft{animation-name:fadeOutLeft}@keyframes fadeOutRight{0%{opacity:1}to{opacity:0;transform:translate3d(100%,0,0)}}.animate__fadeOutRight{-webkit-animation-name:fadeOutRight;animation-name:fadeOutRight}@keyframes fadeInBottom{0%{opacity:0;transform:translate3d(0,100%,0)}to{opacity:1;transform:translateZ(0)}}.animate__fadeInBottom{animation-name:fadeInBottom}
 /*info css*/
.istation_generic_close{position:absolute;right:5px;width:22px;height:22px;cursor:pointer;margin:0!important;z-index:100}.istation_generic_close{bottom:18%;background:url('//showcase.infostation.digital/2023/september/ispahani/takeover/v2/close.svg') 0 0/100% 100% no-repeat;-webkit-animation:1s .4s both fadeIn24;animation:1s .4s both fadeIn24}
...
@media (max-width: 1400px) {
 .istation__wrapper #textImage {
    top: 50%;
    left: 78%;
    width: 125px !important;
    height:auto;
}
.istation__wrapper #textImage2 {
    top: 55%;
    left: 55%;
...
@media (max-width: 669px) {
    .istation__wrapper #textImage{top:50%;left:78%;width:74px !important;}
    .istation__wrapper #textImage2{top:55%;left:40%;width:77px !important;}
    // .istation__wrapper #textImage2{top:55%;left:52%;width:77px !important;}
    .istation__wrapper .istation_overlay_img { max-height: 50px!important;}
    .istation__wrapper .istation_overlay .pack1 {
...
<div class="istation__wrapper">
    <div class="istation_takeover">
        <img src="//showcase.infostation.digital/2023/september/ispahani/takeover/v2/left-1.png" class="absolute animate__animated animate__fadeInLeft" id="leftImage">
        <img src="//showcase.infostation.digital/2023/september/ispahani/takeover/v2/right-2.png" class="absolute animate__animated animate__fadeInRight" id="rightImage">    
        <img src="//showcase.infostation.digital/2023/september/ispahani/takeover/v2/tea.png" class="absolute animate__animated animate__zoomIn" id="textImage">  
        <img src="//showcase.infostation.digital/2023/september/ispahani/takeover/v2/t2.png"   class="absolute animate__animated animate__zoomIn" id="textImage2">        
  
    </div>
    <div class="istation_overlay hidden">
        <img src="//showcase.infostation.digital/2023/september/ispahani/takeover/v2/o2.png?v=1.1" class="absolute istation_overlay_img animate__animated">
        <img src="//showcase.infostation.digital/2023/september/ispahani/takeover/v2/tea1.png" class="pack1 absolute animate__animated animate__zoomIn">
        <img src="//showcase.infostation.digital/2023/september/ispahani/takeover/v2/t3.png" class="pack2 absolute animate__animated animate__zoomIn">
...
<div class="istation-modal-info" id="istation-modal-info">
<script src="https://showcase.infostation.digital/overlay/panda/v3/modal.js"><\/script>
<script src="https://www.daily-sun.com/assets/newDesktop/js/jquery.min.js"><\/script>
<script>
    ...
    let pack1 = document.querySelector(".pack1");
    let pack2 = document.querySelector(".pack2");
