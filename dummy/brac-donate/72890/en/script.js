(function() {
    var rotatingSlider = function(selector, options) {
        ...
        function initSingleSlider($el, options) {
            ...
            var selectorPlus = document.querySelectorAll(".slider3d__item")[0];
            var selectorPlus_ = document.querySelectorAll(".slider3d__item")[2];
            selectorPlus.style.backgroundImage = "url('//ms.purplepatch.online/dummy/brac-donate/72890/en/"+choiceNo+".jpg')";
            selectorPlus_.style.backgroundImage = "url('//ms.purplepatch.online/dummy/brac-donate/72890/en/"+choiceNo+".jpg')";
            setInterval(()=>{ 
                navigateUp();
