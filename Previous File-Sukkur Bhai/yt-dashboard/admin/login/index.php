                  ...
                  <div class="m-sm-4">
                    ...
                    <form action="" method="post">
                      <div class="mb-3">
                        ...
                        <input class="form-control form-control-lg" type="text" name="username" placeholder="Enter Your Adminname" value="<?php echo $username;?>" />
                      </div>
                      <div class="mb-3">
                        ...
                        <small class="errorText" style="color:red;margin-top:5px;">*Incorrect Admin Name or Password</small>
                      </div>
                      <div>
