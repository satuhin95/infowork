...
(function($) {
    $.fn.ClassyCountdown = function(options, callback) {
        ...
        function secondsToDHMS() {
        	var purple_countDownDate = new Date("May 17, 2020 10:00:10").getTime();
			purple_now = new Date().getTime();
			purple_distance = purple_countDownDate - purple_now;
			DaysLeft = Math.floor(purple_distance / (1000 * 60 * 60 * 24));
			HoursLeft = Math.floor((purple_distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
			MinutesLeft = Math.floor((purple_distance % (1000 * 60 * 60)) / (1000 * 60));
			SecondsLeft = Math.floor((purple_distance % (1000 * 60)) / 1000);
			HoursLeft = DaysLeft>0 ?HoursLeft+(DaysLeft*24):HoursLeft;
        }
        ...
        function doTick() {
            ...
            element.find('.ClassyCountdown-days .ClassyCountdown-value > div').html(translteNum(DaysLeft));
            element.find('.ClassyCountdown-hours .ClassyCountdown-value > div').html(translteNum(HoursLeft));
            element.find('.ClassyCountdown-minutes .ClassyCountdown-value > div').html(translteNum(MinutesLeft));
            element.find('.ClassyCountdown-seconds .ClassyCountdown-value > div').html(translteNum(SecondsLeft));
        }
