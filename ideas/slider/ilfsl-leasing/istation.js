var $container = document.getElementById("istation_container");
var $containerWidth = $container.offsetWidth;
TweenMax.set("#istation_container", { perspective: $containerWidth * 1.5 });
TweenMax.set(".slide", {
...
function createSlide(element, index) {
    ...
    if (index === 0) { setActive();} else {setInactive();}
    function setActive() {
        slide.isActive = true;
        TweenLite.fromTo(
            element,
