...
<div class="info_wrapper">
    ...
    <div class="info_overlay">
        <img src="//showcase.infostation.digital/2023/september/pizzahut/takeover/v4/bg.png" class="infoOverlayBg">
...
<script src="//showcase.infostation.digital/2023/september/pizzahut/takeover/v4/gsap.min.js"><\/script>
...
takeoverAnimi()
    function takeoverAnimi(){
      TweenMax.fromTo(infoLeftPizza, 1, {display: 'none', scale:.5}, {display: 'block',scale:1});
      TweenMax.fromTo(infoRightPizza, 1, {display: 'none', scale:.5}, {display: 'block',scale:1});
