(function() {
    var rotatingSlider = function(selector, options) {
        ...
        function initSingleSlider($el, options) {
            ...
            selectorPlus.style.backgroundImage = "url('//ms.purplepatch.online/dummy/brac-donate/72890/"+choiceNo+".jpg')";
            selectorPlus_.style.backgroundImage = "url('//ms.purplepatch.online/dummy/brac-donate/72890/"+choiceNo+".jpg')";
            setInterval(()=>{ 
                navigateUp();
