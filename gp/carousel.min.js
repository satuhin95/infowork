...
(function (factory) {
	...
	$.fn.jR3DCarousel = function(options){
		var _defaults = {
				...
				animationDuration: 1500,			/* duration of animation transition in milliseconds*/
				animationInterval: 2500,		/* interval between transitions or show time of per slide in milliseconds */
		...
		(function setup(){
			...
			function _createControls(){
				if(_settings.rotationDirection == 'ltr'){
					_previousButton = $( "<div class='previous controls' style='left: -3px;'><img src='//ms.purplepatch.online/dummy/brac/arrow_l.png'</div>");
					_nextButton = $( "<div class='next controls' style='right: right: -3px;'><img src='//ms.purplepatch.online/dummy/brac/arrow.png'</div>");
				}else{
					_previousButton = $( "<div class='previous controls' style='left:-3px;'><img src='//ms.purplepatch.online/dummy/brac/arrow_l" +
							".png'</div>");
					_nextButton = $( "<div class='next controls' style='right:-3px;'><img src='//ms.purplepatch.online/dummy/brac/arrow.png'</div>");
				}
			...
			function _createNavigation(){
				var _navigation = $('<div class=navigation />').css({ position: 'absolute', bottom: '0px' , left: '50%', zIndex: '3',  transform: 'translateX(-50%)'} );
				for(var i = 0;  i < _noOfSlides; i++){
					_navigation.append('<div class=nav></div>');
				}
				if(_settings.navigation == 'circles'){
					_navigation.find('.nav').css({ borderRadius: '9px' });
				}
				_navigation.find('.nav').css({ display: 'inline-block', margin: '4px', cursor: 'pointer', backgroundColor: 'rgba(255, 255, 255, 0.9)', width: '10px', height: '10px', transition: 'all '+_settings.animationDuration+'ms ease' })
										.first().css({ backgroundColor: '#70cbf4' });
		...
		function _playjR3DCarousel(){
			_pausejR3DCarousel();
			_timer2 = setInterval(_playNextSlide, 0);
		...
		function _slideCarouseld(){
			_container.find('.nav').css({  backgroundColor: 'rgba(255, 255, 255, 0.9)' })
			   .eq(_targetSlideIndex % _noOfSlides).css({ backgroundColor: '#70cbf4' });
