...
<div class="info_wrapper">
    <div class="info_takeover">
        <img src="./left.png" class="infoImgLeft" />
        <img src="./right.png" class="infoImgright" />
        <img src="./leftpizza.png" class="infoLeftPizza" />
        <img src="./rightpizza.png" class="infoRightPizza" />
            <img src="./bg2.png" class="infoMiddleBg" />
            <img src="./logo.png" class="infoPizzaLogo" />
            <img src="./plus.png" class="infoText" />
            <img src="./01.png" class="infoText1" />
            <img src="./02.png" class="infoText2" />
            <img src="./03.png" class="infoText3" />
    </div>
    <div class="info_overlay">
        <img src="bg.png" class="infoOverlayBg">
        <img src="1.png" class="infoPack1">
        <img src="2.png" class="infoPack2">
        <img src="3.png" class="infoPack3">
     </div>
...
function takeoverAnimi(){
    TweenMax.fromTo(infoImgLeft, 1, {display: 'none', y: '-100vh'}, {display: 'block', y:'0vh'});
    TweenMax.fromTo(infoImgright, 1, {display: 'none', y: '100vh'}, {display: 'block', y:'0vh'});
    TweenMax.fromTo(infoLeftPizza, 1, {display: 'none', scale:.5}, {display: 'block',scale:1},'<=.9');
    TweenMax.fromTo(infoRightPizza, 1, {display: 'none', scale:.5}, {display: 'block',scale:1},'<=.1');
    TweenMax.fromTo(infoMiddleBg, 1, {display: 'none',y: '100vh'}, {display: 'block',y:'0vh'},'<=.1');
    TweenMax.fromTo(infoPizzaLogo, 1, {opacity:'0' ,scale:.5}, {opacity:'1',scale:1},'>=.1');
    TweenMax.fromTo(infoText, 1, {opacity:'0' ,scale:.5}, {opacity:'1',scale:1},'<=.1');
    ...
    TweenMax.fromTo(infoLeftPizza, 4, {rotation:"0"}, {rotation:"90", ease:Linear.easeNone},'<=.1');
    TweenMax.fromTo(infoRightPizza, 4, {rotation:"0"}, {rotation:"90", ease:Linear.easeNone},'<=.01');
        
    setTimeout(function(){
            TweenMax.fromTo(infoText3, 1, {opacity:'1',scale:1},{opacity:'0' ,scale:.5});
            TweenMax.fromTo(infoText2, 1, {opacity:'1',scale:1},{opacity:'0' ,scale:.5},'<=.1');
            TweenMax.fromTo(infoText1, 1, {opacity:'1',scale:1},{opacity:'0' ,scale:.5},'<=.1');
            TweenMax.fromTo(infoText, 1, {opacity:'1',scale:1},{opacity:'0' ,scale:.5},'<=.1');
            TweenMax.fromTo(infoPizzaLogo, 1, {opacity:'1',scale:1},{opacity:'0' ,scale:.5},'<=.1');
            TweenMax.fromTo(infoMiddleBg, 1, {opacity:'1',scale:1},{opacity:'0' ,scale:.5},'<=.1');

            TweenMax.fromTo(infoLeftPizza, 1, {opacity:'1',scale:1},{opacity:'0' ,scale:.5},'<=.1');
            TweenMax.fromTo(infoRightPizza, 1, {opacity:'1',scale:1},{opacity:'0' ,scale:.5},'<=.1');

            TweenMax.fromTo(infoImgLeft, 1.5, {display: 'block', y:'0vh'},{display: 'none', y: '-100vh'},'<=.8');
            TweenMax.fromTo(infoImgright, 1.5, {display: 'block', y:'0vh'},{display: 'none', y: '100vh'},'<=.01');  
            
            TweenMax.fromTo(infoOverlayBg, 2, {display: 'none', y: '50vh',opacity:'0'}, {display: 'block', y:'0vh',opacity:'1'},'<=.1');
            TweenMax.fromTo(infoPack1, 1, {display: 'none',opacity:'0' ,scale:.5}, {display: 'block',opacity:'1',scale:1},'>=.1');
            TweenMax.fromTo(infoPack2, 1, {display: 'none',opacity:'0' ,scale:.5}, {display: 'block',opacity:'1',scale:1},'<=.1');
            TweenMax.fromTo(infoPack3, 1, {display: 'none',opacity:'0' ,scale:.5}, {display: 'block',opacity:'1',scale:1},'<=.1');
